...
const GlobalResult = () => {
  ...
  useEffect(() => {
    const fetchResult = async () => {
      ...
      setIsLoading(true);
      try {
        // logic of fetching data to the server side
        // Fetch every thing all at once as it the global search
  ...
  return (
    <div className="absolute top-full z-10 mt-3 w-full bg-light-800 py-5 shadow-sm dark:bg-dark-400 rounded-xl">
      <GlobalFilters />
      {/* divider line that seperate the result with the GlobalSearchInput */}
              ...
              result.map((item: any, index: number) => (
                ...
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-dark400_light500 small-medium mt-1 fond-bold capitalize">
                      {item.type}
                    </p>
                  </div>
                </Link>
